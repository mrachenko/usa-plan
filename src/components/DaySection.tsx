    ...
    >
      ...
      <div className="mb-8">
        ...
        >
          ...
          <ShareDay dayNumber={config.dayNumber} date={config.date} weekday={config.weekday} title={config.title} subtitle={config.subtitle} description={config.description} transportSummary={config.transportSummary} stops={config.stops} />
